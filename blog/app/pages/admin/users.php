...
<?php elseif ($action == 'edit') : ?>
    ...
    <div class="col-md-6 mx-auto">
        <form method="post">
            ...
            <div class="my-2">
                <label class="d-block">
                    <img class="mx-auto d-block image-priview-edit" src="<?=get_image($row['image'])?>" style="cursor: pointer;width: 150px;height: 150px;object-fit: cover;">
...
<?php else : ?>
    ...
    <div class="table-responsive">
        ...
        <div class="col-md-12 mb-4">
            ...
            <button class="btn btn-primary">Prev Page</button></a>
            <a href="<?=$PAGE['next_link']?>">
            <button class="btn btn-primary float-end">Next Page</button></a>
        </div>
    </div>
